...
public class State {
	...
	static {
		...
		State q11 = new State(6, false);
		State q6 = new State(7, false);
		State q7 = new State(8, false);
		State q8 = new State(9, false);
		State q9 = new State(10, false);
		State q10 = new State(11, true);
		DFA_LALA.addNext('L',q1);
		q1.addNext('a', q2);
		q2.addNext('a', q2);
		q2.addNext(' ', q3);
		q3.addNext(' ', q3);
