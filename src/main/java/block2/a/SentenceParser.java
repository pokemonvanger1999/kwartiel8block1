...
import static block2.Sentence2.ADJECTIVE;
import static block2.Sentence2.ENDMARK;
import static block2.Sentence2.NOUN;
import static block2.Sentence2.VERB;
	...
	public static void main(String[] args) {
		if (args.length == 0) {
			...
			for (String text : args) {
				...
				Lexer lexer = new Sentence2(stream);
				try {
